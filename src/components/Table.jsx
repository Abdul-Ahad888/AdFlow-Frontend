      ...
      <div className="space-y-4">
        <div className="w-full overflow-x-auto">
          <div className="
            ...
            px-8 py-3 bg-slate-50/50 dark:bg-slate-900/50 rounded-xl"
          >
            ...
            {filteredData.map((item) => (
              <div
                ...
                className="
                  min-w-[600px]
                  grid grid-cols-[2fr_1fr_1fr_1fr]
                  items-center px-8 py-5 bg-white dark:bg-slate-800/40 rounded-2xl border border-slate-100 dark:border-slate-800 hover:border-blue-500/30 transition-all duration-200 group"
              >
